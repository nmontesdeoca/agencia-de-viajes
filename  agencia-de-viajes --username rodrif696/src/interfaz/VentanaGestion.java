     ...
     public VentanaGestion(Sistema sistemaP){
          ...
          this.addWindowListener(new java.awt.event.WindowAdapter(){
               public void windowClosing(WindowEvent evento){
                    int respuesta = JOptionPane.showConfirmDialog(null, "¿Desea salir?", "Confirmacion", JOptionPane.WARNING_MESSAGE);
                    ...
                    if((evento.getSource() == agregar) || (evento.getSource() == modificar) ){
                         ...
                         if(nombreP.length() > 0 && apellidoP.length() > 0){
                              ...
                              try{
                                   ...
                                   JOptionPane.showMessageDialog(null, "ERROR: Ingrese un numero valido en la cedula" , "ERROR", JOptionPane.ERROR_MESSAGE);
                                   this.ci.setText("");
                              }
                         }else{
