          ...
          if((evento.getSource() == agregar) || (evento.getSource() == modificar)){
               ...
               if(nombreP.length() > 0){
                    ...
                    try{
                         ...
                         JOptionPane.showMessageDialog(null, "ERROR: Ingrese un numero v�lido en los campos precio y duracion" , "ERROR", JOptionPane.ERROR_MESSAGE);
               ...
               if (!listaPaquetes.isSelectionEmpty()){
                    int respuesta = JOptionPane.showConfirmDialog(null, " �Eliminar este paquete?", "Confirmaci�n", JOptionPane.WARNING_MESSAGE);
